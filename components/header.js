    ...
    return (
        <div className="relative h-16 bg-black w-full">
            ...
            <div className="w-full absolute top-0 justify-center items-center h-full hidden md:flex">
                <ul className="flex text-white text-xl text-gray-600 font-medium cursor-pointer">
                    <ActiveLink activeClass="text-white" route="/">
                        <li className="md:px-4 lg:px-8" onClick={onClickHome}>Principal</li>
                    </ActiveLink>
                    ...
                    <ActiveLink activeClass="text-white" route="/library">
                        <li className="md:px-4 lg:px-8" onClick={onClickLibrary}>Biblioteca</li>
                    </ActiveLink>
                    
                    <li className="px-5 flex items-center" onClick={onClickSearch}>
            ...
            <div className="w-full absolute top-0 justify-center items-center h-full hidden sm:flex md:hidden">
                <ul className="flex text-white text-xl text-gray-600 font-medium cursor-pointer">
                    <ActiveLink activeClass="text-white" route="/">
                        <li className="px-5" onClick={onClickHome}>
                            <svg className="h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    ...
                    <ActiveLink activeClass="text-white" route="/library">
                        <li className="px-5 " onClick={onClickLibrary}>
                            <svg className="h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    ...
                    <li className="px-5" onClick={onClickSearch}>
                        <svg className="h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                            <path d="M12.9 14.32a8 8 0 1 1 1.41-1.41l5.35 5.33-1.42 1.42-5.33-5.34zM8 14A6 6 0 1 0 8 2a6 6 0 0 0 0 12z"/>
                        </svg>
                    </li>
